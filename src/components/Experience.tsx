...
const experiences = [
  ...
  },
  {
    ...
    date: "8th June 2025",
    description:
      "Completed virtual internships in Cybersecurity . Practiced handling data pipelines, dashboards, and audit frameworks with business-oriented solutions.",
  },
    {
    ...
    description:
      "Completed in hands training at banaras locomotive works Acquired practical knowledge of software integration and locomotive automation systems, with exposure to industrial-grade embedded platforms and control mechanisms.",
  },
