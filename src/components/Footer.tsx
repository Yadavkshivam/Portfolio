    ...
    <footer className="bg-black text-white px-6 py-16 border-t border-white/10">
      <div className="max-w-6xl mx-auto grid md:grid-cols-4 sm:grid-cols-2 gap-10 text-sm text-gray-400">
        ...
        >
          ...
          <p>
            I&apos;m Shivam Yadav, a full-stack web developer and tech enthusiast. I love building modern,
        ...
        >
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-center gap-2">
              <FaEnvelope className="text-green-400" /> shivamyadav10981@gmail.com
            </li>
            <li className="flex items-center gap-2">
              <FaPhone className="text-blue-500" /> +91 6394952163
            </li>
          </ul>
        </motion.div>
      </div>
      ...
      <div className="mt-12 text-center text-sm text-gray-600 border-t border-white/10 pt-6">
        © {new Date().getFullYear()} Designed &amp; Built by Shivam Yadav. All rights reserved.
      </div>
    </footer>
  );
}
